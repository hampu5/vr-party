...
onready var vr_origin = $ARVROrigin 
...
func _ready() -> void:
	...
	vr_origin.get_node("LeftController").connect("button_pressed", self, "_on_LeftController_button_pressed")
	vr_origin.get_node("LeftController").connect("button_release", self, "_on_LeftController_button_release")
	
	vr_origin.get_node("RightController").connect("button_pressed", self, "_on_RightController_button_pressed")
	vr_origin.get_node("RightController").connect("button_release", self, "_on_RightController_button_release")
	
	# vr_origin.get_node("LeftController/HandButton").connect("hand_button", self, "_on_HandButton_hand_button")
